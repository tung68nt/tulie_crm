...
const PACKAGES = [
  {
    ...
    name: 'Cơ bản',
    price: 79000,
    desc: 'Thay nền, chỉnh sáng cơ bản, tăng nét nhẹ. Không ghép tóc/áo.',
    freePrints: 1,
    icon: Camera,
  ...
  },
  {
    ...
    name: 'Tiêu chuẩn',
    price: 199000,
    desc: 'Thay nền, chỉnh sáng + da, ghép tóc/xoá tóc mái, làm lộ tai, ghép 1 trang phục. Sửa 2 lần.',
    freePrints: 2,
    icon: Star,
    popular: true,
  ...
  },
  {
    ...
    name: 'Cao cấp',
    price: 339000,
    desc: 'Thay nền, chỉnh sáng + da + màu ảnh cao cấp, ghép tóc, làm lộ tai, ghép 2 trang phục. Sửa 5 lần.',
    freePrints: 4,
    icon: Sparkles,
...
export default function IDPhotoOrderPage() {
  const router = useRouter()
  const [isSubmitting, setIsSubmitting] = useState(false)

  // Multi-package state: {id: qty}
  const [pkgQuantities, setPkgQuantities] = useState<Record<string, number>>({ basic: 0, standard: 1, premium: 0 })
                        ...
                        <div className="flex items-start gap-3 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 flex-wrap">
                              <h3 className="text-[15px] font-bold text-zinc-950 tracking-tight">Gói {pkg.name}</h3>
                              {pkg.popular && (
