...
const mockCustomers = [
    { id: '1', company_name: 'ABC Corporation', tax_code: '0123456789' },
    { id: '2', company_name: 'XYZ Limited', tax_code: '0987654321' },
]

const mockContracts = [
    { id: '1', contract_number: 'HD-2026-0089', customer_id: '1', remaining: 110000000 },
    { id: '2', contract_number: 'HD-2025-0078', customer_id: '1', remaining: 60000000 },
]
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select value={contractId} onValueChange={setContractId}>
                                            ...
                                            <SelectContent>
                                                {mockContracts.map((c) => (
                                                    <SelectItem key={c.id} value={c.id}>
                                                        {c.contract_number} (còn lại: {formatCurrency(c.remaining)})
                                                    </SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
