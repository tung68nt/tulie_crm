...
export default async function ReportsPage() {
 ...
 <CardContent>
 <div className="text-2xl font-semibold">{formatCurrency(stats.revenue.total)}</div>
 ...
 <CardContent>
 <div className="text-2xl font-semibold">{stats.customers.total}</div>
 <p className="text-xs text-green-500 flex items-center mt-1">
 <ArrowUpRight className="h-3 w-3 mr-1" />
 Đã ghi nhận
 </p>
 ...
 <CardContent>
 <div className="text-2xl font-semibold">{stats.contracts.active}</div>
 <p className="text-xs text-green-500 flex items-center mt-1">
 <ArrowUpRight className="h-3 w-3 mr-1" />
 Trạng thái Active
 </p>
 ...
 <CardContent>
 <div className="text-2xl font-semibold">{stats.invoices.pending}</div>
